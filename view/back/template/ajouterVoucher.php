...
require 'C:/xampp/htdocs/integration/view/front/public/PHPMailer-master/src/Exception.php';
require 'C:/xampp/htdocs/integration/view/front/public/PHPMailer-master/src/PHPMailer.php';
require 'C:/xampp/htdocs/integration/view/front/public/PHPMailer-master/src/SMTP.php';  
          ...
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              ...
              <div class="nav-profile-text d-flex flex-column pr-3">
                <span class="font-weight-medium mb-2">Hela Moalla</span>
                <span class="font-weight-normal">Gestion reservation</span>
              </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="Sponors.html">reservation</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/dropdowns.html">evenement</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/typography.html">reclamation</a>
                </li>
              </ul>
            </div>
          </li>
            ...
            <ul class="navbar-nav navbar-nav-right ml-lg-auto">
              ...
              <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                  ...
                  <span class="profile-name">Hela Moalla</span>
                </a>
