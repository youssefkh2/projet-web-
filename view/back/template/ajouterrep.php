...
require 'C:/xampp/htdocs/integration/view/back/template/PHPMailer-master/src/Exception.php';
require 'C:/xampp/htdocs/integration/view/back/template/PHPMailer-master/src/PHPMailer.php';
require 'C:/xampp/htdocs/integration/view/back/template/PHPMailer-master/src/SMTP.php';

include_once 'C:/xampp/htdocs/integration/Model/reponse.php';
    include_once 'C:/xampp/htdocs/integration/controller/reponseC.php';
        ...
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              ...
              <div class="nav-profile-text d-flex flex-column pr-3">
                <span class="font-weight-medium mb-2">Ibtihel Farhat</span>
                <span class="font-weight-normal">Gestion evenement</span>
              </div>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Les gestions</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="afficher_categorie.php">event</a>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav navbar-nav-right ml-lg-auto">
              ...
              <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                  <img class="nav-profile-img mr-2" alt="" src="assets/images/faces/face1.png" />
                  <span class="profile-name">Ibtihel Farhat</span>
                </a>
