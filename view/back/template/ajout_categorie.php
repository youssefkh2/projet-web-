                  ...
                  <!--<button class="btn btn-light" href="event.html"><-</button>-->
                    ...
                    <form class="forms-sample"  action="" method="POST">
                      <div class="form-group">
                        <label for="example1">Nom</label>
                        <input type="text" class="form-control" id="Nom" placeholder="Nom du categorie" name="Nom" required=""  onblur="saisirNom()"/>
                        <p id="errorName" class="erreur" ></p>
                        
                      </div>
                      <div class="form-group">
                        <label for="example2">description</label>
                        <input type="text" class="form-control" id="description"  name="description" placeholder="Taper la description" required="" />
                      </div>
                      
                      
                      
                      
                      <button class="btn btn-light" type="submit" onclick="ajout(event)"> Submit </button>
