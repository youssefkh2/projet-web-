...
<html lang="en">
  ...
  <body>
          ...
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              ...
              <div class="nav-profile-text d-flex flex-column pr-3">
                <span class="font-weight-medium mb-2">Aziz HadjALi</span>
                <span class="font-weight-normal">Gestion Compte</span>
              </div>
	...
	<table>
		<td>
			...
			<table>
				...
				<tr>
					<th><input class = "bouton" type="submit" name="ajouter_utilisateur" value="Ajouter Utilisateur"></th>
	...
	<a id="logout" class="logout" href="logout.php"> Déconnexion </a>
</body>
</html>