        ...
        <div class="container"><a class="navbar-brand" href="index.php"><img src="assets/img/logo.svg" height="31" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item"><a class="nav-link" aria-current="page" href="../../front/profile.php"> Profil</a></li>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 text-md-start text-center py-6">
              ...
              <div class="text-center text-md-start"><a class="btn btn-warning me-3 btn-lg" href="#!" role="button">S'inscrire</a></div>
            </div>
