        ...
        <div class="container">
          ...
          <?php
           ...
           ?>
              ...
              <div class="text-center text-md-start"><a class="btn btn-warning me-3 btn-lg" href="afficherRES.php" role="button">Reserver</a></div><br>
              <div class="text-center text-md-start"><a class="btn btn-warning me-3 btn-lg" href="afficher_sponsors.php" role="button">Sponsor</a></div>
