        ...
        <div >
            ...
            <h3 style="color:#FF0000;">2- Responsabilité::  </h3>
                ...
                <h4> Les participants sont exclusivement et juridiquement responsables des informations qu'ils envoient à un forum. 
                    ...
                    Les participants s'engagent à dégager les organisateurs des forums en ligne du forum Divertify de toute responsabilité quant aux informations qu'ils ont envoyées à un forum.</h4>
            <br><br>
            <div class="card-header">
            <h3 style="color:#FF0000;">3- Exactitude:  </h3>
                </div>
                
                <h4> En tant qu'organisateur d'un forum en ligne, Divertify ne peut garantir l'exactitude de toutes les déclarations faites par des 
                    participants non Membres du Divertify à ce forum.</h4>
            <br><br>
            <div class="card-header">
            <h3 style="color:#FF0000;">4- Citations:  </h3>
                </div>
                
                <h4> Les forums en ligne du Divertify permettent aux participants d'échanger librement leurs points de vue, chacun intervenant à titre personnel.
            ...
            <h3 style="color:#FF0000;">5- Droit d'auteur et utilisation équitable:  </h3>
                ...
                <h4>Tous les participants à un forum en ligne du Divertify détiennent un droit d'auteur sur les informations ou les liens vers des informations qu'ils envoient à ce forum.
                     Toutefois, ils autorisent les autres participants au forum à utiliser ces informations à des fins personnelles ou courantes, y compris pour les renvoyer vers d'autres sites Internet ou créer des liens;
                      toute autre forme de reproduction ou de diffusion de ces informations requiert une autorisation. Les informations du Divertify téléchargées à partir d'un forum ne peuvent être utilisées en dehors de ce forum que si Divertify a donné son autorisation et qu'il est indiqué qu'elle est la source de ces informations.</h4>
            <br><br><br><br>
            <div class="card-header">
                   <h4>Divertify se réserve le droit de refuser ou de supprimer tout message qui constitue, selon elle, une violation des règles ci-dessus. En outre, s'il est établi qu'un participant a enfreint ces règles, il peut se voir à l'avenir refuser l'accès aux forums.</h4>
                </div>
                <br>
                <div class="card-header">
                   <h4>Divertify se réserve le droit d'archiver toutes les observations faites durant un forum dans un dossier permanent sur le forum qui sera accessible en ligne pendant la période qu'elle jugera appropriée.  </h4>
                </div>
                <br>
                <div class="card-header">
                   <h4>Divertify ne divulguera aucun renseignement personnel communiqué par les participants à un forum en ligne à d'autres participants, hormis aux autres organisations qui co-organisent ledit forum. </h4>
                </div>
