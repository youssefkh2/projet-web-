        ...
        <form action="" method="POST">
            ...
            <table border="1" align="center">
               <tr>
                    ...
                    <td>
                        <input type="text" name="nom_event" id="nom_event" value="<?php echo $evenement['nom_event'];?>" maxlength="20" required="" onblur="saisirNom()" >
                ...
                <tr>
                    ...
                    <td>
                        <input type="date" name="date" id="date" value="<?php echo $evenement['date'];?>" required="" required="" onblur="saisirdate_recuperation()" >
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="lieu" id="lieu" value="<?php echo $evenement['lieu'];?>" maxlength="20" required=""  onblur="saisirNom2()">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="heure" id="heure" value="<?php echo $evenement['heure'];?>" required="" required="">
                    </td>
                </tr>
