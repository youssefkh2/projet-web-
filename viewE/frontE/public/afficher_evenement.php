  ...
  <body>
    ...
    <main class="main" id="top">
        ...
        <div class="container"><a class="navbar-brand" href="index.html"><img src="assets/img/logo.svg" height="31" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item"><a class="nav-link" aria-current="page" href="evenement.php">Evenement</a></li>
      ...
      <tr>
        ...
        <td rowspan="4">image</td>
        <td rowspan="4"> 
          <div class="text-center"><a class="btn btn-warning" href="#!" role="button">plus de détaille</a></div>
