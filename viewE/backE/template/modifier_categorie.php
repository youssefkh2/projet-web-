<?php
    ...
    if (
        ...
        //{
            ...
            $CategorieC->modifierCategories($categorie, $_GET["id_cat"]);
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <?php
			                    if (isset($_GET['id_cat'])){
			                            	$categorie = $CategorieC->recupererCategories($_GET['id_cat']);   
                    ...
                    <form class="forms-sample"  action="" method="POST">
                      ...
                      <div class="form-group form-default">
                                                            <label class="float-label">Nom</label>
                                                                <input type="Nom"  id="Nom" name="Nom"  value="<?php echo $categorie['Nom'];?>" class="form-control" required="" >
                      ...
                      <div class="form-group form-default">
                        ...
                        <input type="text" name="description" id="description" value="<?php echo $categorie['description']; ?>" class="form-control">
